...
| 기능 | 설명 |
|---|---|
| 🔊 **TTS 낭독 + 속도 조절** | `SpeechSynthesis`로 가사를 읽어줍니다. **문항 전환 시 2초 뒤 자동 낭독**, 0.5~1.2배 속도(느리게=난이도↓, 빠르게=난이도↑) |
...
| 🔢 **문제 수 선택 + 랜덤 출제** | 기본 설정 화면에서 10/20/30/전체 중 선택 → **시작 시 자동 셔플 1회** 후 그만큼 랜덤 출제 |
